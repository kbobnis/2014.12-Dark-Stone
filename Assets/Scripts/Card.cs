...
public class Card  {
	...
	public static readonly Card IceBolt = new Card("Ice bolt", 2, SpriteManager.IceBoltAnimations, new Dictionary<ParamType, int>() { { ParamType.Health, 1 }, { ParamType.Damage, 1 }, { ParamType.Speed, 2 }, { ParamType.Distance, 1 } });
