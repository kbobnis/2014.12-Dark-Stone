...
public static class IsCastOnMethod {
	...
	public static string Describe(this IsCastOn ico) {
		switch (ico) {
			case IsCastOn.AllFriendlyMinions: return "All friendly minions";
			case IsCastOn.OtherFriendlyMinions: return "Other friendly minions";
			case IsCastOn.AdjacentFriendlyMinions: return "Adjacent friendly minions";
			case IsCastOn.AdjacentFriendlyCharacters: return "Adjacent friendly characters";
			case IsCastOn.AllEnemyCharacters: return "All enemy characters";
			case IsCastOn.AllEnemyMinions: return "All enemy minions";
			case IsCastOn.OtherItsCharacters: return "Other friendly characters";
			case IsCastOn.FriendlyHero: return "Friendly hero";
			case IsCastOn.AllFriendlyCharacters: return "All friendly characters";
...
public class Card  {
	...
	public static readonly Card SavageRoar= new Card("Savage Roar", 3, CardPersistency.UntilEndTurn, CardTarget.Self, 0, IsCastOn.AllFriendlyCharacters, new Dictionary<ParamType, int>() { { ParamType.AttackAdd, 2 } });	
	...
	public static readonly Card Bloodlust = new Card("Bloodlust", 5, CardPersistency.UntilEndTurn, CardTarget.Self, 0, IsCastOn.AllFriendlyMinions, new Dictionary<ParamType, int>() { { ParamType.AttackAdd, 3 } });
	...
	public static readonly Card DarkscaleHeal = new Card("Darkscale Heal", 2, CardPersistency.Instant, CardTarget.Self, 0, IsCastOn.AllFriendlyCharacters, new Dictionary<ParamType, int>() { { ParamType.Heal, 2 } });	
	...
	public static readonly Card Flamestrike = new Card("Flamestrike", 7, CardPersistency.Instant, CardTarget.Self, 0, IsCastOn.AllEnemyMinions, new Dictionary<ParamType, int>() { { ParamType.DealDamageSpell, 4 }});
	...
	public static readonly Card Druid = new Card("Druid", 10, CardPersistency.Hero, CardTarget.Empty, 1, IsCastOn.Target, new Dictionary<ParamType, int>() { { ParamType.Health, 30 }, {ParamType.Speed, 1}}, 
	...
	public static readonly Card Shaman = new Card("Shaman", 10, CardPersistency.Hero, CardTarget.Empty, 1, IsCastOn.Target, new Dictionary<ParamType, int>() { { ParamType.Health, 30 }, { ParamType.Speed, 1 } },
