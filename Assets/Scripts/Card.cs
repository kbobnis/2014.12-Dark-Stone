...
public class Card  {
	...
	public static readonly Card ControlSelf = new Card("Control self", 1, SpriteManager.ShoeAnimations, new Dictionary<ParamType, int>() { {ParamType.OneTimeSpeed, 1} }, null);
	...
	public static readonly Card Zombie = new Card("Zombie", 4, SpriteManager.ZombieAnimations, new Dictionary<ParamType, int>() { { ParamType.Health, 15 }, { ParamType.Damage, 1 }, { ParamType.Distance, 1 }, {ParamType.HisMana, 1}, {ParamType.IncreaseManaEachTurn, 1}, {ParamType.OneTimeSpeed, 1 }}, new List<Card>(){ControlSelf, ControlSelf, ControlSelf, ControlSelf, ControlSelf });
}
