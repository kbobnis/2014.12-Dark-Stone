...
public class Card  {
	...
	public static readonly Card Lasia = new Card("Lasia", 5, SpriteManager.LasiaAnimations, new Dictionary<ParamType, int>() { { ParamType.Health, 30 }, {ParamType.HisMana, 5}, {ParamType.IncreaseManaEachTurn, 1}, {ParamType.Damage, 1}});
